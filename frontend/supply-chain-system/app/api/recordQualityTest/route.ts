...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log("Frontend received RecordQualityTest:", data)
    
    // Forward to backend
    const backendResponse = await fetch('http://localhost:3001/api/recordQualityTest', {
      method: 'POST',
      headers: {
    ...
    console.error("Error in recordQualityTest:", error)
