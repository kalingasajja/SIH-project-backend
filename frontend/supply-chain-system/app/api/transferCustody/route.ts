...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log("Frontend received TransferCustody:", data)
    
    // Forward to backend
    const backendResponse = await fetch('http://localhost:3001/api/transferCustody', {
      method: 'POST',
      headers: {
    ...
    console.error("Error in transferCustody:", error)
