...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log("Frontend received FormulateProduct:", data)
    
    // Forward to backend
    const backendResponse = await fetch('http://localhost:3001/api/formulateProduct', {
      method: 'POST',
      headers: {
    ...
    console.error("Error in formulateProduct:", error)
